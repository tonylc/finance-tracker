...
// ── 1. Load __investmentLib from index.html via VM ──────────────────────────
...
const lib = appCtx.window.__investmentLib;
if (!lib) {
  console.error('ERROR: Could not extract __investmentLib from index.html');
  process.exit(1);
}
